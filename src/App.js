          ...
          <div className="row justify-content-center">
            <div className="col-auto">
              <ul className='list-unstyled d-flex'>
                <li className='me-3'><button onClick={() => demo('mountain')}>Mountain</button></li>
                <li className='me-3'><button onClick={() => demo('city')}>City</button></li>
                <li className='me-3'><button onClick={() => demo('bird')}>Bird</button></li>
                <li ><button onClick={() => demo('car')}>Car</button></li>
